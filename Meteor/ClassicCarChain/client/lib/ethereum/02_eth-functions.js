Ethereum = function(){
	...
	// For now, I should hardcode the address for each session.
	 contractAddress = "0x0e3ba5fb4cd0eb0ef973c5df660c114570113b4b",
	 ...
	 usedAccount = web3.eth.accounts[0];

	function vehicleOwnerAddress(){
		return contractInstance.vehicleOwnerAddress();
	}
	function vehicleModel(){
		return contractInstance.vehicleModel();
	}
	function vehicleManufacturingYear(){
