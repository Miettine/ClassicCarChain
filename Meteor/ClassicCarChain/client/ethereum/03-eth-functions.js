Ethereum = (function() {
	...
	//Use the console to set the value at the beginning of each development
	//var contractAddress = "";
var m_contractAddress="0x";

	var PersistentData = new Mongo.Collection(null);
	PersistentData.insert({contractAddress:m_contractAddress});
	...
	var m_contractInstance = MyContract.at(m_contractAddress);
...
*/
		...
		setContractAddress: function(_address){
			PersistentData.update({contractAddress: _address});
			console.log("eth-functions.setContractAddress "+ _address);
		},

		contractAddress: function(){
			 const address = PersistentData.find();
			 return address;
